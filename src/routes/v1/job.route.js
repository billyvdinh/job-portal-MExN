 ...
 *   get:
 *     summary: Get a job
 *     description: Logged in jobs can fetch only their own job information. Only admins can fetch other jobs.
 *     tags: [Jobs]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in users can only update job information. Only admins can update other jobs.
 *     tags: [Jobs]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in users can delete jobs. Only admins can delete jobs.
 *     tags: [Jobs]
 *     security:
 *       - bearerAuth: []
 *     parameters:
